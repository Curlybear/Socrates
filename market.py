...
class Market:
    ...
    async def food(self, ctx, in_quality: str):
        ...
        if not self.utils.is_number(in_quality):
            return
        r = requests.get('https://api.erepublik.tools/' + apiVersion + '/market/item/best-offers/1/' + in_quality + '?key=' + apiKey)
        ...
        if not offers:
            ...
            for i in range(10):
                ...
                prices += ':dollar: ' + str(offers[i]['gross']) + ' - :package: ' + str(offers[i]['amount']) + '\n'
                links += ':link: [Link to offer](https://www.erepublik.com/en/economy/marketplace/offer/' + str(offers[i]['id']) + ')' + '\n'
    ...
    async def weapons(self, ctx, in_quality: str):
        ...
        r = requests.get('https://api.erepublik.tools/' + apiVersion + '/market/item/best-offers/2/' + in_quality + '?key=' + apiKey)
        obj = json.loads(r.text)
        offers = obj['offers']
    ...
    async def aircrafts(self, ctx, in_quality: str = '1'):
        ...
        r = requests.get('https://api.erepublik.tools/' + apiVersion + '/market/item/best-offers/23/' + in_quality + '?key=' + apiKey)
        obj = json.loads(r.text)
        offers = obj['offers']
    ...
    async def houses(self, ctx, in_quality: str):
        ...
        r = requests.get('https://api.erepublik.tools/' + apiVersion + '/market/item/best-offers/4/' + in_quality + '?key=' + apiKey)
        obj = json.loads(r.text)
        offers = obj['offers']
    ...
    async def tickets(self, ctx, in_quality: str):
        ...
        r = requests.get('https://api.erepublik.tools/' + apiVersion + '/market/item/best-offers/3/' + in_quality + '?key=' + apiKey)
        obj = json.loads(r.text)
        offers = obj['offers']
    ...
    async def frm(self, ctx):
        ...
        r = requests.get('https://api.erepublik.tools/' + apiVersion + '/market/item/best-offers/7/1?key=' + apiKey)
        obj = json.loads(r.text)
        offers = obj['offers']
    ...
    async def wrm(self, ctx):
        ...
        r = requests.get('https://api.erepublik.tools/' + apiVersion + '/market/item/best-offers/12/1?key=' + apiKey)
        obj = json.loads(r.text)
        offers = obj['offers']
    ...
    async def hrm(self, ctx):
        ...
        r = requests.get('https://api.erepublik.tools/' + apiVersion + '/market/item/best-offers/17/1?key=' + apiKey)
        obj = json.loads(r.text)
        offers = obj['offers']
    ...
    async def arm(self, ctx):
        ...
        r = requests.get('https://api.erepublik.tools/' + apiVersion + '/market/item/best-offers/24/1?key=' + apiKey)
        obj = json.loads(r.text)
        offers = obj['offers']
