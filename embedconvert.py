...
embed = discord.Embed(
    title="FIST",
    url="http://wiki.erepublik.com/index.php/Formidable_International_Security_Treaty",
...
embed.set_author(
    name="azaraliiii#4764",
    url="https://discordapp.com/channels/@me/344531696479109120",
...
embed = discord.Embed(
    ...
    url="http://wiki.erepublik.com/index.php/Northern_Alliance",
...
embed = discord.Embed(
    title="Mediterranean Alliance",
    url="http://wiki.erepublik.com/index.php/Mediterranean_Alliance",
...
embed = discord.Embed(
    ...
    url="http://wiki.erepublik.com/index.php/Byzantine_Empire",
...
embed.set_thumbnail(
    url="http://wiki.erepublik.com/images/2/29/Flag-New_Byzantine_Empire.jpg"
)
...
embed.add_field(
    name="Founders", value=":flag_gr: Greece - :flag_tr: Turkey", inline=False
)
...
embed = discord.Embed(
    title="PANAM",
    url="http://wiki.erepublik.com/index.php/Pan_American_Alliance",
...
embed = discord.Embed(
    title="ATLANTIS",
    url="http://wiki.erepublik.com/index.php/ATLANTIS",
...
embed = discord.Embed(
    title="PEACE GC",
    url="http://wiki.erepublik.com/index.php/PEACE",
...
embed = discord.Embed(
    title="ALA",
    url="http://wiki.erepublik.com/index.php/ALA",
...
embed = discord.Embed(
    title="Sol",
    url="http://wiki.erepublik.com/index.php/Sol",
...
embed.add_field(
    name="Other members",
    value=":flag_bo: Bolivia - :flag_il: Israël - :flag_za: South Africa - :flag_th: Thailand",
    inline=True,
)
...
embed = discord.Embed(
    title="Fortis",
    url="http://wiki.erepublik.com/index.php/Fortis",
...
embed = discord.Embed(
    title="Brolliance",
    url="http://wiki.erepublik.com/index.php/Brolliance",
...
embed.add_field(
    name="Other members",
    value=":flag_au: Australia - :flag_ie: Ireland - :flag_jp: Japan",
    inline=True,
)
...
embed = discord.Embed(
    title="Entente",
    url="http://wiki.erepublik.com/index.php/Entente",
...
embed.add_field(
    name="Founders",
    value=":flag_fr: France - :flag_it: Italy - :flag_ua: Ukraine",
    inline=True,
)
embed.add_field(
    name="Other members",
    value=":flag_be: Belgium - :flag_mx: Mexico - :flag_py: Paraguay - :flag_ve: Venezuela",
    inline=True,
)
...
embed = discord.Embed(
    title="Phoenix",
    url="http://wiki.erepublik.com/index.php/Phoenix",
...
embed = discord.Embed(
    title="ONE",
    url="http://wiki.erepublik.com/index.php/Order_of_Nations_of_eRepublik",
...
embed.set_thumbnail(
    url="http://wiki.erepublik.com/images/6/66/Flag-Order_of_Nations_of_eRepublik.png"
)
...
embed = discord.Embed(
    title="PACMAN",
    url="http://wiki.erepublik.com/index.php/PACMAN",
...
embed.add_field(
    name="Founders",
    value=":flag_my: Malaysia - :flag_ph: Philippines - :flag_sg: Singapore",
    inline=False,
)
...
embed = discord.Embed(
    title="Luna",
    url="http://wiki.erepublik.com/index.php/Luna",
...
embed.add_field(
    name="Founders",
    value=":flag_il: Israël - :flag_in: India - :flag_ph: Philippines - :flag_my: Malaysia",
    inline=False,
)
embed.add_field(
    name="Other members",
    value=":flag_ch: Switzerland - :flag_at: Austria - :flag_uy: Uruguay",
    inline=True,
)
...
embed = discord.Embed(
    title="CAS",
    url="http://wiki.erepublik.com/index.php/Confederation_of_Arab_States",
...
embed.set_thumbnail(
    url="http://wiki.erepublik.com/images/1/1c/Flag-Confederation_of_Arab_States.png"
)
embed.add_field(name="Formation", value="1303", inline=False)
embed.add_field(name="Disbanded", value="1411", inline=False)
embed.add_field(name="All time members", value="2", inline=False)
embed.add_field(
    name="Founders", value=":flag_eg: Egypt - :flag_sa: Saudi Arabia", inline=False
)
...
embed.add_field(
    name="Other members", value=":flag_at: Austria - :flag_eg: Egypt", inline=True
)
...
embed = discord.Embed(
    title="ONE (NWO)",
    url="http://wiki.erepublik.com/index.php/Order_of_New_EWorld",
...
embed.add_field(
    name="Founders",
    value=":flag_hu: Hungary - :flag_pl: Poland - :flag_rs: Serbia - :flag_es: Spain",
    inline=False,
)
embed.add_field(
    name="Other members",
...
embed = discord.Embed(
    title="Terra",
    url="http://wiki.erepublik.com/index.php/Terra",
...
embed.set_thumbnail(
    url="http://wiki.erepublik.com/images/archive/9/94/20131012010638%21Flag-Terra.png"
)
...
embed.add_field(
    name="Founders",
    value=":flag_br: Brazil - :flag_ar: Argentina - :flag_us: USA",
    inline=False,
)
embed.add_field(
    name="Other members",
...
embed = discord.Embed(
    title="CTRL",
    url="http://wiki.erepublik.com/index.php/Came_To_Rock,_Literally",
...
embed.add_field(
    name="Founders",
    value=":flag_br: Brazil - :flag_pl: Poland - :flag_es: Spain - :flag_us: USA",
    inline=False,
)
...
embed = discord.Embed(
    title="ABC",
    url="http://wiki.erepublik.com/index.php/Alliance_of_Baltic_Countries",
...
embed.add_field(
    name="Founders",
    value=":flag_ee: Estonia - :flag_lt: Lithuania - :flag_lv: Latvia",
    inline=False,
)
...
embed = discord.Embed(
    title="GEA",
    url="http://wiki.erepublik.com/index.php/Garden_of_EDEN_Alliance",
...
embed.add_field(
    name="Founders",
    value=":flag_al: Albania - :flag_in: India - :flag_nl: Netherlands",
    inline=False,
)
embed.add_field(
    name="Other members",
...
embed = discord.Embed(
    title="EDEN",
    url="http://wiki.erepublik.com/index.php/Erepublik_Defence_%26_Economy_Network",
...
embed = discord.Embed(
    title="CoT",
    url="http://wiki.erepublik.com/index.php/Circle_of_Trust",
...
embed = discord.Embed(
    title="NaN",
    url="http://wiki.erepublik.com/index.php/NaN",
...
embed.add_field(name="All time members", value="8", inline=False)
embed.add_field(
    name="Founders", value=":flag_au: Australia - :flag_za: South Africa", inline=False
)
embed.add_field(
    name="Other members",
...
embed = discord.Embed(
    title="TWO",
    url="http://wiki.erepublik.com/index.php/The_World_is_Ours",
    description="TWO (The World is Ours) was a military alliance consisting of 19 members. Big countries were called TWO, and small ones were called ACT.",
    color=0x0065CA,
)
embed.set_author(
    name="azaraliiii#4764",
...
embed.add_field(
    name="Founders",
    value=":flag_hu: Hungary - :flag_pl: Poland - :flag_rs: Serbia - :flag_es: Spain - :flag_gb: United Kingdom",
    inline=False,
)
embed.add_field(
    name="Other members",
    value=":flag_gr: Greece - :flag_lv: Latvia - :flag_ee: Estonia - :flag_ve: Venezuela - :flag_th: Thailand - :flag_me: Montenegro - :flag_sk: Slovakia - :flag_lt: Lithuania - :flag_tw: Taiwan - :flag_at: Austria - :flag_by: Belarus - :flag_au: Australia - :flag_nz: New Zealand",
    inline=False,
)
...
embed = discord.Embed(
    title="WOLF",
    url="http://wiki.erepublik.com/index.php/The_World_is_Ours",
    description="WOLF (World Organization of Loyalty and Freedom) was a military alliance consisting of 3 members.",
    color=0x00FF00,
)
embed.set_author(
    name="azaraliiii#4764",
...
embed.add_field(
    name="Founders",
    value=":flag_pk: Pakistan - :flag_eg: Egypt - :flag_sa: Saudi Arabia",
    inline=False,
)
...
embed = discord.Embed(
    title="Sirius",
    url="http://wiki.erepublik.com/index.php/Sirius",
    description="Sirius was a military alliance consisting of 8 members. The alliance was ended because screenshot was found proving Poland was requesting to join Asteria.",
    color=0x36A8C9,
)
embed.set_author(
    name="azaraliiii#4764",
...
embed.add_field(
    name="Founders",
    value=":flag_hr: Croatia - :flag_pl: Poland - :flag_es: Spain - :flag_tr: Turkey - :flag_gb: United Kingdom - :flag_us: USA",
    inline=False,
)
embed.add_field(
    name="Other members", value=":flag_br: Brazil - :flag_ua: Ukraine", inline=False
)
...
embed = discord.Embed(
    title="Aurora",
    url="http://wiki.erepublik.com/index.php/Aurora",
    description="Aurora was an alliance of nations committed to loyalty, liberty, and dignity, for all member nations.",
    color=0xFF0080,
)
embed.set_author(
    name="azaraliiii#4764",
...
embed.add_field(
    name="Founders",
    value=":flag_bg: Bulgaria - :flag_cl: Chile - :flag_de: Germany - :flag_id: Indonesia - :flag_ie: Ireland - :flag_mk: Macedonia - :flag_py: Paraguay",
    inline=False,
)
embed.add_field(
    name="Other members",
    value=":flag_mx: Mexico - :flag_it: Italy - :flag_ve: Venezuela",
    inline=False,
)
...
embed = discord.Embed(
    title="Leto",
    url="http://wiki.erepublik.com/index.php/Leto",
    description="It was founded after TWO was dissolved. It consisted mostly of ex-ACT or ex-proTWO smaller countries. It was an organization subsidiary of Asteria alliance.  After dissolution of Leto and Asgard, their small-sized members formed Nebula and their mid-sized members formed Orion.",
    color=0x400040,
)
embed.set_author(
    name="azaraliiii#4764",
...
embed.add_field(
    name="Founders",
    value=":flag_by: Belarus - :flag_co: Colombia - :flag_il: Israël - :flag_pt: Portugal - :flag_tw: Taiwan - :flag_md: Moldova",
    inline=False,
)
embed.add_field(
    name="Other members",
    value=":flag_ca: Canada - :flag_fr: France - :flag_ir: Iran - :flag_pe: Peru - :flag_me: Montenegro - :flag_au: Australia - :flag_cz: Czech Republic ",
    inline=False,
)
...
embed = discord.Embed(
    title="Asgard",
    url="http://wiki.erepublik.com/index.php/Asgard",
...
embed.add_field(name="All time members", value="4", inline=False)
embed.add_field(
    name="Founders", value=":flag_se: Sweden - :flag_fi: Finland", inline=False
)
embed.add_field(
    name="Other members", value=":flag_ca: Canada - :flag_no: Norway", inline=False
)
...
embed = discord.Embed(
    title="Root",
    url="http://wiki.erepublik.com/index.php/Root",
    description="Root was a military alliance consisting of 5 countries.",
    color=0xFFFFFF,
)
embed.set_author(
    name="azaraliiii#4764",
...
embed.add_field(
    name="Founders",
    value=":flag_sk: Slovakia - :flag_kr: South Korea - :flag_ch: Switzerland - :flag_lt: Lithuania - :flag_ee: Estonia - :flag_ba: Bosnia and Herzegovina",
    inline=False,
)
embed.add_field(
    name="Other members",
    value=":flag_ge: Georgia - :flag_al: Albania - :flag_by: Belarus",
    inline=False,
)
...
embed = discord.Embed(
    title="P.L.U.T.O.",
    url="http://wiki.erepublik.com/index.php/P.L.U.T.O.",
    description="P.L.U.T.O. (also called PLUTO) was a military alliance consisting of 7 countries.",
    color=0xFFFFFF,
)
embed.set_author(
    name="azaraliiii#4764",
...
embed.add_field(
    name="Founders",
    value=":flag_be: Belgium - :flag_es: Spain - :flag_gb: United Kingdom",
    inline=False,
)
embed.add_field(
    name="Other members",
    value=":flag_kr: South Korea - :flag_mx: Mexico - :flag_py: Paraguay - :flag_bo: Bolivia",
    inline=False,
)
...
embed = discord.Embed(
    title="Syndicates",
    url="http://wiki.erepublik.com/index.php/Syndicate",
    description="Syndicate was a military alliance founded as an anti-Asteria alliance",
    color=0xFF8040,
)
embed.set_author(
    name="azaraliiii#4764",
...
embed.add_field(
    name="Founders",
    value=":flag_ar: Argentina - :flag_br: Brazil - :flag_gr: Greece - :flag_tr: Turkey",
    inline=False,
)
embed.add_field(
    name="Other members",
    value=":flag_cl: Chile - :flag_ua: Ukraine - :flag_it: Italy - :flag_hr: Croatia ",
    inline=False,
)
...
embed = discord.Embed(
    title="Adriatica",
    url="http://wiki.erepublik.com/index.php/Adriatica",
    description="Adriatica was started with the idea of joining anti-Asteria countries, however, within few months all major members left to join Syndicate. Several small countries joined afterwards.",
    color=0x804000,
)
embed.set_author(
    name="azaraliiii#4764",
...
embed.add_field(
    name="Other members",
    value=":flag_ve: Venezuela - :flag_th: Thailand - :flag_ge: Georgia - :flag_it: Italy - :flag_al: Albania - :flag_cl: Chile - :flag_cy: Cyprus - :flag_ie: Ireland - :flag_mx: Mexico",
    inline=False,
)
...
embed = discord.Embed(
    title="Orion",
    url="http://wiki.erepublik.com/index.php/Orion",
    description="Orion is a medium-sized alliance, friendly to Asteria. It was founded after Leto was dissolved.",
    color=0x0000A0,
)
embed.set_author(
    name="azaraliiii#4764",
...
embed.add_field(
    name="Founders",
    value=":flag_ca: Canada - :flag_fr: France - :flag_co: Colombia - :flag_ir: Iran - :flag_pe: Peru - :flag_se: Sweden",
    inline=False,
)
embed.add_field(
    name="Other members",
    value=":flag_nl: Netherlands - :flag_lt: Lithuania - :flag_cu: Cuba - :flag_gb: United Kingdom - :flag_ee: Estonia",
    inline=False,
)
...
embed = discord.Embed(
    title="Nebula",
    url="http://wiki.erepublik.com/index.php/Nebula",
    description="As outlined in the Nebula alliance charter, Nebula's primary objectives are to defend and protect each member country against foreign invaders and to fight for Asteria and its allies.",
    color=0x979700,
)
embed.set_author(
    name="azaraliiii#4764",
...
embed.add_field(
    name="Founders",
    value=":flag_au: Australia - :flag_il: Israël - :flag_me: Montenegro - :flag_jp: Japan - :flag_no: Norway",
    inline=False,
)
embed.add_field(
    name="Other members",
    value=":flag_cz: Czech Republic - :flag_uy: Uruguay - :flag_at: Austria",
    inline=False,
)
...
embed = discord.Embed(
    title="Pacifica",
    url="http://wiki.erepublik.com/index.php/Pacifica_(alliance)",
    description="It was a medium-size alliance until Poland and Hungary joined it in April 2016, which then turned it into one of the major alliances in the game. It has mostly followed the path of neutrality between Asteria and Syndicate since, keeping MPPs with both sides and avoiding major conflicts",
    color=0xDF0005,
)
embed.set_author(
    name="azaraliiii#4764",
...
embed.add_field(
    name="Other members",
    value=":flag_lv: Latvia - :flag_tw: Taiwan - :flag_fi: Finland - :flag_co: Colombia - :flag_se: Sweden - :flag_gr: Greece - :flag_hu: Hungary - :flag_pl: Poland - :flag_ar: Argentina - :flag_br: Brazil - :flag_mx: Mexico",
    inline=False,
)
...
embed = discord.Embed(
    title="Asteria",
    url="http://wiki.erepublik.com/index.php/Asteria",
    description="Asteria is a military alliance founded after TWO was dissolved.",
    color=0xFF0000,
)
embed.set_author(
    name="azaraliiii#4764",
...
embed.add_field(
    name="Founders",
    value=":flag_ar: Argentina - :flag_gr: Greece - :flag_hu: Hungary - :flag_ro: Romania - :flag_rs: Serbia - :flag_si: Slovenia",
    inline=False,
)
embed.add_field(
    name="Other members",
    value=":flag_cn: China - :flag_br: Brazil - :flag_pt: Portugal - :flag_pe: Peru - :flag_ir: Iran - :flag_lt: Lithuania",
    inline=False,
)
...
embed = discord.Embed(
    title="Andes",
    url="http://wiki.erepublik.com/index.php/Andes",
    description="Andes is an alliance of six countries from South America",
    color=0x800000,
)
embed.set_author(
    name="azaraliiii#4764",
...
embed.add_field(
    name="Founders",
    value=":flag_ve: Venezuela - :flag_cl: Chile - :flag_uy: Uruguay - :flag_bo: Bolivia",
    inline=False,
)
embed.add_field(
    name="Other members", value=":flag_ar: Argentina - :flag_py: Paraguay", inline=False
)
...
embed = discord.Embed(
    title="ADC",
    url="http://wiki.erepublik.com/index.php/Alliance_of_Developing_Countries",
    description="The Alliance of Developing Countries (abbr. 'ADC') is a military alliance consisting of small countries that are not formally aligned with or against any major power bloc.",
    color=0x2EC4DE,
)
embed.set_author(
    name="azaraliiii#4764",
...
embed.set_thumbnail(
    url="http://wiki.erepublik.com/images/6/67/Flag-Alliance_of_Developing_Countries.png"
)
embed.add_field(name="Formation", value="3661", inline=False)
embed.add_field(name="Disbanded", value="Still running", inline=False)
embed.add_field(name="All time members", value="2", inline=False)
embed.add_field(
    name="Founders", value=":flag_ch: switzerland - :flag_md: Moldova", inline=False
)
...
c = conn.cursor()
c.execute(
    "CREATE TABLE wiki(id INTEGER PRIMARY KEY, tag TEXT, category TEXT, embed TEXT)"
)

for jem in jsonembeds:
    c.execute(
        "INSERT INTO wiki(tag, category, embed) VALUES (?,?,?)",
        (jem[1], "Alliance", jem[0]),
    )
