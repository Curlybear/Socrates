XP_BASE_GROUND = [
	0, 15, 45, 80, 120, 170, 250, 350, 450, 600, 800, 1000, 1400, 1850, 2350, 3000, 3750, 5000, 6500, 9000, 12000, 15500, 20000,
	25000, 31000, 40000, 52000, 67000, 85000, 110000, 140000, 180000, 225000, 285000, 355000, 435000, 540000, 660000, 800000,
...
RANKS_GROUND = [
	...
	'Sergeant', 'Sergeant*', 'Sergeant**', 'Sergeant***', 'Lieutenant', 'Lieutenant*', 'Lieutenant**', 'Lieutenant***',
	'Captain', 'Captain*', 'Captain**', 'Captain***', 'Major', 'Major*', 'Major**', 'Major***',
	'Commander', 'Commander*', 'Commander**', 'Commander***', 'Lt Colonel', 'Lt Colonel*', 'Lt Colonel**', 'Lt Colonel***',
	'Colonel', 'Colonel*', 'Colonel**', 'Colonel***', 'General', 'General*', 'General**', 'General***',
...
RANKS_AIR = ['Airman', 'Airman 1st Class', 'Airman 1st Class*', 'Airman 1st Class**', 'Airman 1st Class***', 'Airman 1st Class****', 'Airman 1st Class*****',
	...
	'Staff Sergeant', 'Staff Sergeant*', 'Staff Sergeant**', 'Staff Sergeant***', 'Staff Sergeant****', 'Staff Sergeant*****',
	'Aviator', 'Aviator*', 'Aviator**', 'Aviator***', 'Aviator****', 'Aviator*****',
	'Flight Lieutenant', 'Flight Lieutenant*', 'Flight Lieutenant**', 'Flight Lieutenant***', 'Flight Lieutenant****', 'Flight Lieutenant*****',
	'Squadron Leader', 'Squadron Leader*', 'Squadron Leader**', 'Squadron Leader***', 'Squadron Leader****', 'Squadron Leader*****',
	'Chief Master Sergeant', 'Chief Master Sergeant*', 'Chief Master Sergeant**', 'Chief Master Sergeant***', 'Chief Master Sergeant****', 'Chief Master Sergeant*****',
